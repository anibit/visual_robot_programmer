...
Blockly.Block.prototype.initSvg = function() {
  ...
  Blockly.bindEvent_(this.svg_.getRootElement(), 'mousedown', this,
                     this.onMouseDown_);
  Blockly.bindEvent_(this.svg_.getRootElement(), 'contextmenu', this,
                     this.onContextMenu_);
...
Blockly.Block.prototype.onMouseDown_ = function(e) {
  if (Blockly.isRightButton(e)) {
  	//Firefox did not handle right click mousedown events, 
  	//as of v34, so we're doing all right click via the contextmenu event
  	e.stopPropagation();
  	return;
  }	
 ...
 * @private
 */
Blockly.Block.prototype.onContextMenu_ = function(e) {
  // Update Blockly's knowledge of its own location.
  Blockly.svgResize();

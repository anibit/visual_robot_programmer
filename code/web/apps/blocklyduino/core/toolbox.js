...
/**
 * Whether or not to show advanced options
 */
 
Blockly.Toolbox.enableAdvancedBlocks_ = false;
...
Blockly.Toolbox.enableAdvancedBlocks = function(enable) {
	Blockly.Toolbox.enableAdvancedBlocks_ = enable;
   Blockly.Toolbox.languageTree = Blockly.Toolbox.buildTree_();
   Blockly.Toolbox.redraw();
   Blockly.Toolbox.position_();
   // Make the 'Blocks' tab line up with the toolbox.
   var changedEvent = new Event("advancedChanged"); 
   changedEvent.initEvent("advancedChanged", true, false);
   window.parent.document.dispatchEvent(changedEvent);
 ...
 */
Blockly.Toolbox.init = function(enableAdvanced) {
...
Blockly.Toolbox.buildTree_ = function() {
  ...
  for (var name in Blockly.Language) {
    ...
    if (block.category && (Blockly.Toolbox.enableAdvancedBlocks_ || !block.isAdvanced)) {
